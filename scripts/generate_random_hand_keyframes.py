...
def grasp_can_keyframe(index: int, count: int, rng: random.Random) -> tuple[str, list[float]]:
    path = [
        ...
        ("lift_open", [-0.23, -0.035, 0.03, -0.26, 0.05, -0.07, 0.02]),
        ("reach_far_open", [-0.18, 0.015, 0.035, -0.22, 0.04, -0.06, 0.03]),
        ("reach_mid_open", [-0.12, 0.065, 0.035, -0.16, 0.03, -0.05, 0.04]),
        ("reach_near_open", [-0.05, 0.105, 0.03, -0.10, 0.02, -0.035, 0.05]),
        ("pregrasp_left_open", [0.005, 0.128, 0.025, -0.055, 0.012, -0.02, 0.06]),
        ("pregrasp_center_open", [0.045, 0.140, 0.02, -0.025, 0.006, -0.01, 0.08]),
        ("palm_at_can_open", [0.072, 0.146, 0.018, -0.008, 0.000, 0.00, 0.10]),
        ("contact_can_open", [0.083, 0.146, 0.018, 0.000, -0.004, 0.006, 0.16]),
        ("touch_can_10", [0.086, 0.146, 0.018, 0.002, -0.006, 0.010, 0.24]),
        ("wrap_can_25", [0.088, 0.146, 0.018, 0.004, -0.008, 0.014, 0.36]),
        ("wrap_can_40", [0.089, 0.146, 0.018, 0.006, -0.010, 0.018, 0.50]),
        ("wrap_can_60", [0.089, 0.146, 0.018, 0.008, -0.010, 0.022, 0.66]),
        ("wrap_can_80", [0.088, 0.145, 0.018, 0.010, -0.010, 0.024, 0.82]),
        ("grasp_can_closed", [0.087, 0.145, 0.018, 0.012, -0.010, 0.026, 0.98]),
        ("hold_can_closed_01", [0.087, 0.145, 0.018, 0.012, -0.010, 0.026, 1.00]),
        ("hold_can_closed_02", [0.086, 0.145, 0.018, 0.010, -0.009, 0.024, 1.00]),
        ("hold_can_closed_03", [0.085, 0.145, 0.018, 0.008, -0.008, 0.022, 0.96]),
        ("release_can_80", [0.084, 0.144, 0.018, 0.006, -0.006, 0.018, 0.80]),
        ("release_can_60", [0.082, 0.143, 0.019, 0.004, -0.004, 0.014, 0.60]),
        ("release_can_40", [0.076, 0.140, 0.020, 0.000, -0.002, 0.010, 0.40]),
        ("release_can_20", [0.064, 0.135, 0.022, -0.006, 0.000, 0.004, 0.22]),
        ("open_clear_can", [0.040, 0.124, 0.025, -0.020, 0.006, -0.006, 0.10]),
        ("retreat_near_open", [0.000, 0.100, 0.030, -0.050, 0.014, -0.020, 0.06]),
        ("retreat_mid_open", [-0.080, 0.050, 0.032, -0.120, 0.030, -0.045, 0.04]),
        ("return_home_open", [-0.170, -0.020, 0.026, -0.210, 0.045, -0.065, 0.03]),

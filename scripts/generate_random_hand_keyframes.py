...
def grasp_can_keyframe(index: int, count: int, rng: random.Random) -> tuple[str, list[float]]:
    path = [
        ...
        ("pregrasp_center_horizontal", [-0.005, 0.142, 0.020, -0.025, 0.006, -1.32, 0.08]),
        ("palm_left_of_can_open", [0.004, 0.146, 0.018, -0.008, 0.000, -1.36, 0.10]),
        ("palm_left_of_can_settle", [0.006, 0.146, 0.018, -0.004, -0.002, -1.37, 0.12]),
        ("finger_contact_can", [0.010, 0.146, 0.018, 0.000, -0.004, -1.38, 0.16]),
        ("finger_contact_confirm", [0.012, 0.146, 0.018, 0.001, -0.005, -1.385, 0.20]),
        ("thumb_touch_surface", [0.014, 0.146, 0.018, 0.002, -0.006, -1.39, 0.24]),
        ("thumb_pad_settle", [0.016, 0.146, 0.018, 0.003, -0.007, -1.395, 0.30]),
        ("wrap_can_25_horizontal", [0.018, 0.146, 0.018, 0.004, -0.008, -1.40, 0.36]),
        ("wrap_can_32_horizontal", [0.019, 0.146, 0.018, 0.005, -0.009, -1.40, 0.43]),
        ("wrap_can_40_horizontal", [0.021, 0.146, 0.018, 0.006, -0.010, -1.40, 0.50]),
        ("wrap_can_50_horizontal", [0.022, 0.146, 0.018, 0.007, -0.010, -1.40, 0.58]),
        ("wrap_can_60_horizontal", [0.023, 0.146, 0.018, 0.008, -0.010, -1.40, 0.66]),
        ("wrap_can_70_horizontal", [0.024, 0.1455, 0.018, 0.009, -0.010, -1.395, 0.74]),
        ("wrap_can_80_horizontal", [0.024, 0.145, 0.018, 0.010, -0.010, -1.39, 0.82]),
        ("wrap_can_90_horizontal", [0.024, 0.145, 0.018, 0.011, -0.010, -1.385, 0.91]),
        ("grasp_can_closed_horizontal", [0.024, 0.145, 0.018, 0.012, -0.010, -1.38, 0.98]),
        ("hold_can_closed_01_horizontal", [0.024, 0.145, 0.018, 0.012, -0.010, -1.38, 1.00]),
        ("hold_can_closed_02_horizontal", [0.024, 0.145, 0.018, 0.011, -0.010, -1.38, 1.00]),
        ("hold_can_closed_03_horizontal", [0.0235, 0.145, 0.018, 0.010, -0.0095, -1.38, 1.00]),
        ("hold_can_closed_04_horizontal", [0.023, 0.145, 0.018, 0.010, -0.009, -1.38, 1.00]),
        ("hold_can_closed_05_horizontal", [0.0225, 0.145, 0.018, 0.009, -0.0085, -1.37, 1.00]),
        ("hold_can_closed_06_horizontal", [0.022, 0.145, 0.018, 0.008, -0.008, -1.36, 0.98]),
        ("release_can_80_horizontal", [0.020, 0.144, 0.018, 0.006, -0.006, -1.32, 0.80]),
        ("release_can_70_horizontal", [0.018, 0.1435, 0.0185, 0.005, -0.005, -1.27, 0.70]),
        ("release_can_60_horizontal", [0.016, 0.143, 0.019, 0.004, -0.004, -1.22, 0.60]),
        ("release_can_50_horizontal", [0.013, 0.1415, 0.0195, 0.002, -0.003, -1.135, 0.50]),
        ("release_can_40_horizontal", [0.010, 0.140, 0.020, 0.000, -0.002, -1.05, 0.40]),
        ("release_can_30_horizontal", [0.005, 0.1375, 0.021, -0.003, -0.001, -0.935, 0.30]),
        ("release_can_20_horizontal", [0.000, 0.135, 0.022, -0.006, 0.000, -0.82, 0.22]),
